...
- Phone calls: +91 7903946440
- WhatsApp: +91 7992278315
...
function localReply(message) {
  const answers = [
    ...
    [/roas|result|performance|retention|numbers|metric/i, "Prime Polo does not present unverified portfolio averages as a promise. Expected results depend on the offer, margins, market demand, competition, sales process, tracking quality, creative and starting baseline. During Discovery, the team defines realistic targets, dependencies and leading indicators for the proposed scope."],
