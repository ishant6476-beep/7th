(() => {
  ...
  async function mount(){
    ...
    tab.addEventListener("click",()=>{shell.classList.add("edu-crm-active");tabs.querySelectorAll("button").forEach(b=>b.classList.toggle("active",b===tab));panel.hidden=false;load()});
