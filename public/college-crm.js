(() => {
  ...
  async function mount(){
    ...
    tab.addEventListener("click",()=>{shell.classList.remove("site-editor-active","advanced-cms-active");document.querySelector('.site-editor-panel')?.setAttribute('hidden','');document.querySelector('.advanced-cms-panel')?.setAttribute('hidden','');shell.classList.add("edu-crm-active");tabs.querySelectorAll("button").forEach(b=>b.classList.toggle("active",b===tab));panel.hidden=false;load()});
